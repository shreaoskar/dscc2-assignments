...
pub export fn linearArraySearch(arg_array: [*c]c_int, arg_count: c_uint, arg_number: c_int) void {
    var array = arg_array;
    _ = &array;
    var count = arg_count;
    _ = &count;
    ...
    {
        iterator = 0;
        while (@as(c_uint, @bitCast(iterator)) < count) : (iterator += 1) {
            if (number == (blk: {
                const tmp_1 = iterator;
                if (tmp_1 >= 0) break :blk array + @as(usize, @intCast(tmp_1)) else break :blk array - ~@as(usize, @bitCast(@as(isize, @intCast(tmp_1)) +% -1));
            }).*) {
                _ = printf("%d ", iterator);
                tmp += 1;
            }
    ...
    if (tmp == @as(c_int, 0)) {
        _ = printf("No Matches Found\n");
    } else {
        _ = printf("\n");
    }
}
pub const separatedArrayElements = extern struct {
    odd: [*c]c_int = @import("std").mem.zeroes([*c]c_int),
    even: [*c]c_int = @import("std").mem.zeroes([*c]c_int),
    count: c_uint = @import("std").mem.zeroes(c_uint),
};
pub export fn separatedOddElements(arg_array: [*c]c_int, arg_arrays: separatedArrayElements, arg_count: c_uint) separatedArrayElements {
    var array = arg_array;
    _ = &array;
    var arrays = arg_arrays;
    _ = &arrays;
    var count = arg_count;
    _ = &count;
    var iterator: c_int = undefined;
    ...
    {
        iterator = 0;
        while (@as(c_uint, @bitCast(iterator)) < count) : (_ = blk: {
            iterator += @as(c_int, 2);
            break :blk blk_1: {
                const ref = &j;
                const tmp = ref.*;
            ...
            (blk: {
                const tmp = j;
                if (tmp >= 0) break :blk arrays.even + @as(usize, @intCast(tmp)) else break :blk arrays.even - ~@as(usize, @bitCast(@as(isize, @intCast(tmp)) +% -1));
            }).* = (blk: {
                const tmp = iterator;
    ...
    j = 0;
    {
        ...
        while (@as(c_uint, @bitCast(iterator)) < count) : (_ = blk: {
            ...
            (blk: {
                const tmp = j;
                if (tmp >= 0) break :blk arrays.odd + @as(usize, @intCast(tmp)) else break :blk arrays.odd - ~@as(usize, @bitCast(@as(isize, @intCast(tmp)) +% -1));
            }).* = (blk: {
                const tmp = iterator;
                if (tmp >= 0) break :blk array + @as(usize, @intCast(tmp)) else break :blk array - ~@as(usize, @bitCast(@as(isize, @intCast(tmp)) +% -1));
            }).*;
    ...
    arrays.count = count / @as(c_uint, @bitCast(@as(c_int, 2)));
    return arrays;
}
pub export fn descendingArray(arg_array: [*c]c_int, arg_count: c_uint) void {
    var array = arg_array;
    _ = &array;
    var count = arg_count;
    _ = &count;
    ...
    {
        i = 0;
        while (@as(c_uint, @bitCast(i)) < (count -% @as(c_uint, @bitCast(@as(c_int, 1))))) : (i += 1) {
            {
                j = 1;
                while (@as(c_uint, @bitCast(j)) < count) : (j += 1) {
                    if ((blk: {
                        const tmp_1 = i;
                        if (tmp_1 >= 0) break :blk array + @as(usize, @intCast(tmp_1)) else break :blk array - ~@as(usize, @bitCast(@as(isize, @intCast(tmp_1)) +% -1));
                    }).* < (blk: {
...
pub export fn factorial(arg_number: c_uint) c_int {
    var number = arg_number;
    _ = &number;
    if (number <= @as(c_uint, @bitCast(@as(c_int, 1)))) return 1 else return @as(c_int, @bitCast(number *% @as(c_uint, @bitCast(factorial(number -% @as(c_uint, @bitCast(@as(c_int, 1))))))));
    return 0;
}
pub export fn nCr(arg_n: c_int, arg_r: c_int) c_int {
    var n = arg_n;
    _ = &n;
    var r = arg_r;
    _ = &r;
    return @divTrunc(factorial(@as(c_uint, @bitCast(n))), factorial(@as(c_uint, @bitCast(r))) * factorial(@as(c_uint, @bitCast(n - r))));
}
pub export fn isPrime(arg_number: c_uint) bool {
    var number = arg_number;
    _ = &number;
    var count: c_int = 0;
    _ = &count;
    ...
    {
        i = 2;
        while (@as(f64, @floatFromInt(i)) <= sqrt(@as(f64, @floatFromInt(number)))) : (i += 1) {
            if ((number % @as(c_uint, @bitCast(i))) == @as(c_uint, @bitCast(@as(c_int, 0)))) {
                count += 1;
            }
        }
    }
    if (count == @as(c_int, 0)) return @as(c_int, 1) != 0 else return @as(c_int, 0) != 0;
    return false;
}
pub export fn primeFactors(arg_number: c_uint) void {
    var number = arg_number;
    _ = &number;
    var count: c_int = 0;
    _ = &count;
    var i: c_int = undefined;
    _ = &i;
    _ = printf("Prime Factors of %d: ", number);
    {
        i = 2;
        while (@as(f64, @floatFromInt(i)) <= sqrt(@as(f64, @floatFromInt(number)))) : (i += 1) {
            if ((@as(c_int, @intFromBool(isPrime(@as(c_uint, @bitCast(i))))) != 0) and ((number % @as(c_uint, @bitCast(i))) == @as(c_uint, @bitCast(@as(c_int, 0))))) {
                _ = printf("%d ", i);
                count += 1;
            }
        }
    ...
    if (count == @as(c_int, 0)) {
        _ = printf("No Match Found\n");
    } else {
        _ = printf("\n");
    }
}
pub export fn perfectNumbers(arg_lowerBound: c_uint, arg_upperBound: c_uint) void {
    var lowerBound = arg_lowerBound;
    _ = &lowerBound;
    var upperBound = arg_upperBound;
    _ = &upperBound;
    if (lowerBound < @as(c_uint, @bitCast(@as(c_int, 2)))) {
        lowerBound = 2;
    }
    var count: c_int = 0;
    _ = &count;
    ...
    {
        i = @as(c_int, @bitCast(lowerBound));
        while (@as(c_uint, @bitCast(i)) <= upperBound) : (i += 1) {
            var sum: c_int = 0;
            _ = &sum;
            {
                j = 1;
                while (j < (@divTrunc(i, @as(c_int, 2)) + @as(c_int, 1))) : (j += 1) {
                    if (@import("std").zig.c_translation.signedRemainder(i, j) == @as(c_int, 0)) {
                        sum += j;
                    }
                }
            }
    ...
    if (count == @as(c_int, 0)) {
        _ = printf("No Perfect Numbers Found\n");
    } else {
        _ = printf("\n");
    }
}
pub export fn exponent(arg_x: c_int, arg_y: c_int) f64 {
    var x = arg_x;
    _ = &x;
    var y = arg_y;
    _ = &y;
    if (y == @as(c_int, 0)) return 1;
    if (y < @as(c_int, 0)) return @as(f64, @floatFromInt(@as(c_int, 1))) / exponent(x, -y);
    return @as(f64, @floatFromInt(x)) * exponent(x, y - @as(c_int, 1));
}
pub export fn gcd(arg_x: c_int, arg_y: c_int) c_int {
    var x = arg_x;
    _ = &x;
    var y = arg_y;
    _ = &y;
    ...
    }
    {
        ...
        while (i > @as(c_int, 0)) : (i -= 1) {
            if ((@import("std").zig.c_translation.signedRemainder(x, i) == @as(c_int, 0)) and (@import("std").zig.c_translation.signedRemainder(y, i) == @as(c_int, 0))) return i;
        }
    }
    return 0;
}
pub export fn swapNumbers(arg_a: [*c]c_int, arg_b: [*c]c_int) void {
    var a = arg_a;
    _ = &a;
    var b = arg_b;
    _ = &b;
...
pub export fn charCount(arg_str: [*c]u8) c_int {
    var str = arg_str;
    _ = &str;
    var count: c_int = 0;
    _ = &count;
    var string: [*c]u8 = str;
    _ = &string;
    while (@as(c_int, @bitCast(@as(c_uint, string.*))) != @as(c_int, '\x00')) {
        if (@as(c_int, @bitCast(@as(c_uint, string.*))) != @as(c_int, ' ')) {
            count += 1;
        }
        string += 1;
    }
...
pub export fn pptopptoint(arg_p: [*c]c_int) void {
    var p = arg_p;
    _ = &p;
    var pp: [*c][*c]c_int = &p;
    _ = &pp;
...
pub const complexNumber = extern struct {
    real: c_int = @import("std").mem.zeroes(c_int),
    imag: c_int = @import("std").mem.zeroes(c_int),
};
pub export fn additionComplex(arg_a: complexNumber, arg_b: complexNumber) complexNumber {
    var a = arg_a;
    _ = &a;
    var b = arg_b;
    _ = &b;
    var result: complexNumber = complexNumber{
        .real = a.real + b.real,
        .imag = a.imag + b.imag,
    };
    _ = &result;
...
pub const Employee = extern struct {
    EmpID: c_int = @import("std").mem.zeroes(c_int),
    EmpName: [*c]u8 = @import("std").mem.zeroes([*c]u8),
    DOJ: date = @import("std").mem.zeroes(date),
    Salary: f32 = @import("std").mem.zeroes(f32),
};
pub export fn initials(arg_name: [*c]u8) void {
    var name = arg_name;
    _ = &name;
}
